...
// const vaultPath = "D:\\OneDrive\\OBSIDIAN\\FSN Second Brain"; // Caminho do vault no Windows
const vaultPath = "/mnt/onedrive/OBSIDIAN/FSN Second Brain"; // Caminho do vault no Linux
